                    ...
                    return (
                        <FlexColCenter>
                            ...
                            <Span size="s" align="center">
                                ({props.getValue().wins}
                                <Span size="s" color="lightgreen">
                                    W
                                </Span>{" "}
                                / {props.getValue().totalMatches - props.getValue().wins}
                ...
                cell: (props) => {
                    ...
                    return (
                        <FlexColCenter>
                            ...
                            <Span size="s" align="center">
                                ({stat(row.kills, row.totalMatches)},{" "}
                                <Span size="s" color="#ff6961">
                                    {stat(row.deaths, row.totalMatches)}
                                </Span>
                                , {stat(row.assists, row.totalMatches)})
                            </Span>
                        </FlexColCenter>
                    );
                },
