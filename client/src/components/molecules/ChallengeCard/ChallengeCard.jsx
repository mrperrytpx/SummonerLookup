            ...
            <FlexRow gap="0.5rem">
                {isVisible && (
                    <ImageContainer
                        ...
                        src={`https://ddragon.leagueoflegends.com/cdn/img/challenges-images/${challenge?.challengeId}-${
                            challenge?.level === "NONE" ? "IRON" : challenge?.level
                        }.png`}
                        alt="Challenge badge"
                        width="46px"
                        radius="50%"
                ...
                <FlexCol data-info gap="0.25rem">
                    <div>
                        <Span width="auto" size="m">
                            <b>{challengeData.name + " "}</b>
                        </Span>
                        <Span width="auto" size="sm">
                    ...
                    <Span size="s">
                        <em>
                            ...
                            better than {Math.round((1 - challenge.percentile) * 100)}% of {SERVER_VALUES[server]} -{" "}
                            <b>{challenge.level}</b> tier
                        </em>
                    </Span>
                    <Span width="auto" align="right" size="xs">
                        {new Intl.DateTimeFormat("en-GB", {
                            dateStyle: "long",
                            timeStyle: "short",
                        }).format(challenge.achievedTime)}
                    </Span>
                </FlexCol>
            </FlexRow>
        </StyledChallengeCard>
