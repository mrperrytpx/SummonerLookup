...
router.post(
    ...
    rateLimiter,
    authMiddleware,
    asyncHandler(summonerController.followSummonerRoute)
);
/**
 * @openapi
...
router.delete(
    ...
    rateLimiter,
    authMiddleware,
    asyncHandler(summonerController.unfollowSummonerRoute)
);
/**
 * @openapi
...
router.get(
    "/search_summoner/:server/:summonerName/",
    asyncHandler(summonerController.searchSummonerRoute)
);
/**
 * @openapi
...
router.get(
    "/matches/:server/:puuid/:page",
    asyncHandler(summonerController.summonerMatchesRoute)
);
/**
 * @openapi
...
router.get(
    ...
    asyncHandler(summonerController.summonerMatchDetailsRoute)
);
/**
 * @openapi
...
router.get(
    "/challenges/:server/:puuid",
    asyncHandler(summonerController.summonerChallenges)
);
/**
 * @openapi
...
router.get(
    "/ranked_stats/:server/:summonerId",
    asyncHandler(summonerController.summonerRankedStatsRoute)
);
/**
 * @openapi
